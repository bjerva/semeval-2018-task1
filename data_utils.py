...
def read_word_data(trainfiles, devfiles, testfiles, word_to_id, word_vectors, max_sent_len):
    ...
    for trainfile in trainfiles:
        (X_train_ids, y_train_ids, word_to_id, filtered_word_to_id, tag_to_id) = utils.load_word_data(trainfile, word_to_id, filtered_word_to_id, tag_to_id, max_sent_len, is_training=True)
    ...
    for devfile in devfiles:
        (X_dev_ids, y_dev_ids,_,_,_) = utils.load_word_data(devfile, word_to_id, filtered_word_to_id, tag_to_id, max_sent_len)
    ...
    if testfiles:
        for testfile in testfiles:
            (X_test_ids, y_test_ids,_,_,_) = utils.load_word_data(testfile, word_to_id, filtered_word_to_id, tag_to_id, max_sent_len)
    ...
    return (X_train, y_train), (X_dev, y_dev), (X_test, y_test), word_vectors, word_to_id
